...
#'
#' @return data with one hot encoded additionnal variables for visits for lunch or dinner
#' @export
#'
...
#'
#' @return data with additionnal one hot encoded variables for levels of time individuals take in advance to book restaurant
#' @export
#'
#' @importFrom dplyr select mutate case_when
#' @importFrom purrr map
...
#' @param data dataframe with categorical variable "reserve_date" indicating date on which reservation was made
#'
#' @return data with additionnal one hot encoded variables for beginning, middle or end of month for all dates
#' @export
#'
#' @importFrom dplyr select mutate case_when
#' @importFrom purrr map
