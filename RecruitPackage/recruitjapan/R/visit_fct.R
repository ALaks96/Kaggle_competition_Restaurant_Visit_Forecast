...
#'
#' @return data with one hot encoding for each day of the month
#' @export
#'
...
#'
#' @return data with one hot encoded additionnal variables for every hour of the day
#' @export
#'
#' @importFrom dplyr select
#' @importFrom purrr map
...
#' @param data dataframe with categorical variable "visit_date" indicating date of visit
#'
#' @return data with one hot encoded additionnal variables for every month of the year
#' @export
#'
#' @importFrom dplyr select
#' @importFrom purrr map
...
#' @param data dataframe with categorical variable "visit_date" indicating date of visit
#'
#' @return data with one hot encoded additionnal variables for every year in our data
#' @export
#'
#' @importFrom dplyr select
#' @importFrom purrr map
...
#'
#' @return data with one hot encoded additionnal variables for every area name for every given location of our id's in our dataset
#' @export
#'
...
#'
#' @return data with one hot encoded additionnal variables for day of the week
#' @export
#'
#' @importFrom dplyr select
#' @importFrom purrr map
...
#'
#' @return data with one hot encoded additionnal variables for longitude coordinates of the locations of every id in our data
#' @export
#'
#' @importFrom dplyr select
#' @importFrom purrr map
...
#'
#' @return data with one hot encoded additionnal variables for latitude coordinates of the locations of every id in our data
#' @export
#'
#' @importFrom dplyr select
#' @importFrom purrr map
...
#'
#' @return data with one hot encoded additionnal variables for every day which is flagged as a holiday
#' @export
#'
#' @importFrom dplyr select
#' @importFrom purrr map
...
#'
#' @return data with one hot encoded additionnal variables for every style of cuisine of our id's
#' @export
#'
#' @importFrom dplyr select
#' @importFrom purrr map
