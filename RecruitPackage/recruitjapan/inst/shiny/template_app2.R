    ...
    mainPanel(
      ...
      tabPanel("Time overview ",sidebarPanel(strong("Output selection"),
                               ...
                               conditionalPanel(condition = "input.time =='visit_date'",
                                                dateRangeInput("daterangex", "Date range:",
...
server <- function(input, output) {
   ...
   pp1 <- eventReactive(input$refresh,{general_overview(df,input$time,input$daterangex,input$hours1,input$hours2,input$day)})
